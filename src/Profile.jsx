...
function Profile({ session, username, currentUserId, viewedUserId, onBack, onViewProfile, onLogout, supabase }) {
    ...
    useEffect(() => {
        fetchProfile();
        fetchUserPosts();
    }, [profileUserId]); // Re-fetch when viewing different user
    ...
    async function fetchUserPosts() {
        ...
        .from('posts')
        .select('*, reactions(vote_type), comments(id)')
        ...
        <div className="p-8">
            ...
            <div className="bg-gray-800 rounded-2xl border border-gray-700 p-8 mb-8">
                ...
                <div className="flex-1">
                    <h1 className="text-3xl font-bold text-blue-400 mb-2">{profile?.username}</h1>
